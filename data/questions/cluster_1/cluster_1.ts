export const cluster_1 = [
  ...
  },
  {
    id: 37,
    question:
      "You are tasked with developing a new quality management system for your radiology department. Which of the following would be included in this system?",
    options: [
  ...
  },
  {
    id: 45,
    question:
      "A department processes 750 films monthly, and their goal is to have a reject rate no higher than 3%. Last month, 28 films were rejected. Did they meet their goal?",
    options: [
  ...
  },
  {
    id: 50,
    question:
      "After performing a white light fogging test inside the darkroom, which of the following should you pay attention to?",
    options: [
  ...
  },
  {
    id: 2052,
    question:
      "Which of the following would suggest that Intensifying screen and film are not fully in close contact with each other?",
    options: [
      "Black fogging at the edge of the film",
      "Localized burning",
      "Densities of uncovered and covered side of the film is unequal",
  ...
  },
  {
    id: 2057,
    question:
      "Biologic effects of radiation that occur relatively soon after humans receive high doses of ionizing radiation are called what?",
    options: [
  ...
  },
  {
    id: 2091,
    question:
      "Which of the following is the similarity found in the operation of scintillation detectors and solid-state detectors?",
    options: [
