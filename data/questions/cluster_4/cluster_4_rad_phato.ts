export const cluster_4_rad_phato = [
  {
    id: 1,
  ...
  },
  {
    ...
    options: [
      "obstruction of the cystic duct by an impacted cholelith",
      "damage of the gallbladder mucosa due to stones",
  ...
  {
    id: 28,
    question: "Which of the following lead to atrial septal defect?",
    options: [
      "fistula between the left and right atrium",
      "improper closure of the ductus ateriosus",
  ...
  {
    id: 31,
    question: "Which of the following group of brittle bone disease is present at birth?",
    options: [
  ...
  {
    id: 35,
    question: "Medullary tumors of the adrenal gland is imaged in nuclear medicine using which radiopharmaceutical?",
    options: [
  ...
  {
    id: 38,
    question: "What is the composition of majority of the stones in the gallbladder?",
    options: [
      "Pure cholesterol",
      "Mixture of cholesterol, bile pigment and calcium salts",
      "Pure calcium salts",
  ...
  {
    id: 58,
    question: "Which procedure is useful in the differential diagnosis between medical and surgical jaundice?",
    options: [
  ...
  {
    id: 63,
    question: "Which of the following is a characteristic of Type 2 DM?",
    options: [
      "the cells are insensitive to insulin",
  ...
  {
    id: 66,
    question: "Which scanner is specific for the imaging of the heart?",
    options: [
  ...
  {
    id: 67,
    question: "Which of the following most likely has the best prognosis?",
    options: [
  ...
  {
    id: 83,
    question: "How will you adjust technical factors in respiratory conditions that add fluid to the lungs?",
    options: [
      "decrease technical factors",
      "use normal technical factors",
  ...
  {
    id: 84,
    question: "The term atherothrombotic brain infarction denotes:",
    options: [
      "Brain hemorrhage caused by atherosclerosis",
      "Infarction caused by thrombosis of a cerebral artery",
  ...
  },
  {
    id: 85,
    question:
      "Narrowing of the coronary arteries that may be due to hypertension, obesity, smoking, high-cholesterol diet, or lack of exercise is generally termed as?",
    options: [
  ...
  {
    id: 93,
    question: "Which of the following structure helps in making KUB visible radiographically?",
    options: [
      "fluid content of the kidneys",
  ...
  {
    id: 95,
    question: "Which of the following is used to localize and treat renal calculi?",
    options: [
