...
import { questions as questionData} from "@/app/actions/cluster4/Cluster4Action1/questions";
...
const SecondSet = () => {
  ...
  if (showResults) {
    ...
    if (score === totalQuestions) {
      ...
      resultMessage = "Pasado pero hindi perpekto";
  ...
  return (
    <div className="p-6 text-center w-screen h-screen bg-[#47366D] text-[#fafafa] flex flex-col justify-center">
      <h1 className="text-3xl font-bold text-[#39ff14]">Cluster 4: Set 1</h1>
      <h2 className="text-2xl font-bold mb-4">
