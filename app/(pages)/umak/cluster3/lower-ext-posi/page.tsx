...
import { questions as questionData } from "@/app/actions/cluster3/lower-ext-posi/questions";
...
const SecondSet = () => {
  ...
  return (
    <div className="p-6 text-center w-screen h-screen bg-[#47366D] text-[#fafafa] flex flex-col justify-center">
      <h1 className="text-3xl font-bold text-[#39ff14]">Cluster 3: Lower-ext-posi</h1>
      <h2 className="text-2xl font-bold mb-4">
