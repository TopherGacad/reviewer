export const questions = [
  {
    id: 51,
    question:
      "What is the half-life of a radioisotope if its activity decreases from 800 Bq to 100 Bq in 6 hours?",
  ...
  },
  {
    id: 52,
    question:
      "A patient is to receive 120 mGy of radiation over 20 minutes. What is the average dose rate in mGy/min?",
    options: ["5 mGy/min", "6 mGy/min", "7 mGy/min", "8 mGy/min"],
    correctAnswer: 1,
    rationale:
      "Divide the total dose by the time: 120 mGy ÷ 20 min = 6 mGy/min.",
  },
  {
    id: 53,
    question:
  ...
  },
  {
    ...
    correctAnswer: 1,
    rationale:
      "The equivalent dose = absorbed dose * tissue weighting factor. Therefore, 30 mGy * 0.12 = 3.6 mSv.",
  },
  {
    id: 55,
    question:
  ...
  },
  {
    ...
    correctAnswer: 0,
    rationale:
      "The magnification factor is calculated as image size/object size: 3 cm ÷ 2 cm = 1.5.",
  },
  {
    id: 60,
    question:
      "If the exposure time for a radiograph is 0.25 seconds at 200 mA, what is the mAs for this exposure?",
    options: ["25 mAs", "50 mAs", "75 mAs", "100 mAs"],
    correctAnswer: 1,
    rationale:
      "mAs = mA * time. For this problem: 200 mA * 0.25 seconds = 50 mAs.",
  },
  {
    id: 61,
    question:
  ...
  },
  {
    ...
    correctAnswer: 0,
    rationale:
      "The first 50% reduction leaves 200 mGy. A second 50% reduction leaves 100 mGy.",
  },
  {
    id: 63,
    question:
    ...
    correctAnswer: 0,
    rationale:
      "Total dose = dose rate * time. Therefore, 0.5 mGy/min * 12 min = 6 mGy.",
  },
  {
    id: 64,
    question:
  ...
  },
  {
    ...
    options: [
      "Increase mAs by 2.25x",
      "Increase mAs by 1.5x",
      "Increase mAs by 2x",
      "Increase mAs by 3x",
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    correctAnswer: 1,
    rationale:
      "Equivalent dose is calculated as effective dose / tissue weighting factor: 12 mSv ÷ 0.01 = 120 mSv.",
  },
  {
    id: 67,
    question:
  ...
  },
  {
    ...
    correctAnswer: 2,
    rationale:
      "The product of mA and time (mAs) remains the same, so the image brightness is unaffected.",
  },
  {
    id: 69,
    question:
  ...
  },
  {
    id: 71,
    question:
      "Which of the following radiographic techniques most significantly reduces patient dose?",
    options: [
      "Increasing SID",
      "Using a grid",
      "Increasing kVp and reducing mAs",
  ...
  },
  {
    ...
    correctAnswer: 0,
    rationale:
      "Total dose = (15 min * 3 mGy/min) + (5 min * 1.5 mGy/min) = 45 mGy + 7.5 mGy = 52.5 mGy.",
  },
  {
    id: 83,
    question:
    ...
    correctAnswer: 1,
    rationale:
      "Reducing SID from 150 cm to 100 cm reduces the distance by 1/3, so the mAs should be reduced by 1/2.",
  },
  {
    id: 84,
    question:
      "In MRI, how does decreasing the echo time (TE) affect image contrast?",
    options: [
      "Improves T1 contrast",
      "Reduces T2 weighting",
      "Increases scan time",
      "Enhances tissue detail",
    ],
    correctAnswer: 1,
    rationale:
      "Decreasing the echo time (TE) reduces T2 weighting, as less time is allowed for transverse relaxation.",
  },
  {
    id: 85,
    question:
    ...
    correctAnswer: 1,
    rationale:
      "Equivalent dose = absorbed dose * tissue weighting factor. Therefore, 50 mGy * 0.05 = 2.5 mSv.",
  },
  {
    id: 86,
    question:
      "Which factor has the most significant impact on increasing spatial resolution in digital radiography?",
    options: [
      "Increasing mAs",
      "Increasing SID",
  ...
  },
  {
    ...
    correctAnswer: 0,
    rationale:
      "Increasing kVp by 15% allows the mAs to be halved. Therefore, 12 mAs / 2 = 6 mAs.",
  },
  {
    id: 90,
    question:
      "In fluoroscopy, what is the purpose of the last image hold (LIH) feature?",
    options: [
      "Reduces image noise",
  ...
  },
  {
    id: 91,
    question:
      "In digital radiography, what is the main benefit of using a higher matrix size in an image acquisition?",
    options: [
  ...
  },
  {
    id: 94,
    question:
      "What is the primary advantage of using a smaller focal spot in radiography?",
    options: [
      "Decreased patient dose",
    ...
    correctAnswer: 1,
    rationale:
      "A smaller focal spot size decreases penumbra, resulting in sharper, more detailed images.",
  },
  {
    id: 95,
    question:
    ...
    correctAnswer: 0,
    rationale:
      "Effective dose = absorbed dose * tissue weighting factor. Therefore, 4 mGy * 0.1 = 0.4 mSv.",
  },
  {
    id: 96,
    question:
  ...
  },
  {
    ...
    correctAnswer: 1,
    rationale:
      "Reducing mAs reduces both patient dose and image brightness because fewer x-rays are produced.",
  },
  {
    id: 100,
    question:
      "What is the primary function of the Automatic Exposure Control (AEC) in radiography?",
    options: [
