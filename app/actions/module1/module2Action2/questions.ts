export const questions = [
  ...
  },
  {
    id: 11,
    question:
      "The largest contributor to man-made ionizing radiation exposure in the general population is:",
    options: [
  ...
  },
  {
    id: 12,
    question:
      "Which of the following is considered a non-ionizing form of electromagnetic radiation?",
  ...
  },
  {
    id: 13,
    question:
      "In radiographic practice, what is the function of the collimator?",
    options: [
  ...
  },
  {
    id: 14,
    question:
      "Which scientist is associated with the development of the moving grid used to reduce scatter radiation?",
    options: [
      "Gustav Bucky",
      "Wilhelm Roentgen",
      "Hollis Potter",
  ...
  },
  {
    id: 16,
    question:
      "The primary advantage of using a radiographic intensifying screen is to:",
    options: [
  ...
  },
  {
    id: 18,
    question:
      "Which device in radiology serves to convert light energy into electrical signals for image formation?",
  ...
  },
  {
    id: 20,
    question:
      "Which of the following types of energy are released during a chemical reaction?",
    options: [
      "Kinetic energy",
      "Chemical energy",
      "Thermal energy",
  ...
  },
  {
    id: 21,
    question:
      "X-ray photons are primarily produced by which process in the X-ray tube?",
    options: [
  ...
  },
  {
    id: 23,
    question:
      "What is the typical annual dose of radiation from natural environmental sources for an average person?",
    options: [
      "50 mrem/year",
      "300 mrem/year",
      "600 mrem/year",
  ...
  },
  {
    id: 26,
    question:
      "The image receptor in digital radiography primarily functions to:",
    options: [
  ...
  },
  {
    id: 28,
    question:
      "Who developed the Coolidge X-ray tube, which is still the basis for modern X-ray tubes?",
    options: [
      "Thomas Edison",
      "Wilhelm Roentgen",
      "William D. Coolidge",
  ...
  },
  {
    id: 29,
    question:
      "Which of the following is the best practice when examining a patient using ionizing radiation?",
    options: [
  ...
  },
  {
    id: 31,
    question:
      "The primary purpose of using lead-lined protective apparel in radiology is to:",
    options: [
      "Increase image sharpness",
  ...
  },
  {
    ...
    options: [
      "High kVp",
      "Low atomic number of the target material",
      "Low kVp",
  ...
  },
  {
    id: 34,
    question:
      "Which process is most responsible for generating X-rays in diagnostic radiology?",
    options: [
      "Compton scattering",
      "Bremsstrahlung radiation",
      "Coherent scattering",
  ...
  },
  {
    id: 35,
    question:
      "What is the main purpose of using beam collimation during radiographic exams?",
    options: [
  ...
  },
  {
    id: 36,
    question:
      "Which interaction between X-rays and matter results in the creation of an ion pair?",
    options: [
      "Compton scattering",
      "Coherent scattering",
      "Photoelectric effect",
  ...
  },
  {
    id: 37,
    question:
      "In fluoroscopy, which device is used to amplify light for better image quality?",
  ...
  },
  {
    id: 41,
    question:
      "The Coolidge X-ray tube was a significant advancement because it allowed for:",
    options: [
  ...
  },
  {
    id: 43,
    question:
      "In radiologic imaging, what is the main consequence of increasing the mA?",
    options: [
  ...
  },
  {
    id: 44,
    question:
      "Which scientist is credited with demonstrating the first application of collimation and filtration?",
    options: [
      "Thomas Edison",
      "William Rollins",
      "Wilhelm Roentgen",
  ...
  },
  {
    id: 46,
    question:
      "A higher atomic number in target material results in which of the following?",
    options: [
  ...
  },
  {
    id: 47,
    question:
      "The primary radiation safety recommendation for technologists during fluoroscopy is to:",
    options: [
      "Increase kVp",
  ...
  },
  {
    id: 48,
    question:
      "Which unit is used to measure radiation exposure to biological tissue?",
  ...
  },
  {
    id: 49,
    question:
      "In radiographic practice, the term ‘scatter radiation’ refers to:",
    options: [
